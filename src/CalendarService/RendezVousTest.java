...
public class RendezVousTest {
    ...
    public static final File ConfigurationFile = new File("." + System.getProperty("file.separator") + "RendezVous");
    ...
    public static void main(String[] args) {
    	 try {
             ...
             Communication hello = new Communication(TcpPort, MyNetworkManager, false);
             hello.start(); 
